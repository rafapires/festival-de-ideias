					...
					<div class='row-fluid'>
						<div class='span5'>
							<a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home">
								<img id='fdi_logo' src='<?php echo get_bloginfo('template_url'); ?>/img/fdi-quarta-chamada.jpg' />
							</a>
						</div>
						<div class='span6 offset1'>
							<div class='well'>
								<a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home">
									Este é um site agregador das ideias que vão ser cocriadas antes e durante o grande encontro do Festival de Ideias 2013/14.
								</a>
							</div>
						</div>
					</div>
